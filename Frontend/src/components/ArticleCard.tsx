...
export default (props: ArticleCardProps) => {
  ...
  <Card className="my-3 mx-auto mx-md-3 border-0 animated--shadow-translate">
    ...
    <CardBody className="d-flex flex-column">
      ...
      <div className="text-titillium d-flex my-3 flex-wrap flex-grow-1 text-break">
        After a day of diligently copying from Stackoverflow and Google searches, you finally ready
        to build...
      </div>
      ...
      <a className="full-div-link z-1" href="/Article/View/54"></a>
    </CardBody>
  </Card>;
};
